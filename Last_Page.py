...
aahail_image_path = r"Graph_Theory_Project\src\aahail.ppm" # Replace with the actual path to the image
khuzaima_image_path = r"Graph_Theory_Project\src\khuzaima.ppm"# Replace with the actual path to the image
khubaib_image_path = r"Graph_Theory_Project\src\khubaib.ppm"  # Replace with the actual path to the image
